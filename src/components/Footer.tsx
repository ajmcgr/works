          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap justify-center gap-x-6 gap-y-1">
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Media Relations</Link>
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Crisis Communication</Link>
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Brand Communications</Link>
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Content Strategy</Link>
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Influencer Marketing</Link>
                <Link to="/services" className="text-gray-600 text-xs hover:text-black transition-colors">Event Management</Link>
              </div>
            </div>
