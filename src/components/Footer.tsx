      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 max-w-4xl">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            {/* Services */}
            <div>
              <h4 className="text-xl font-medium text-black mb-3 tracking-wide">Services</h4>
            ...
            {/* Apps */}
            <div>
              <h4 className="text-xl font-medium text-black mb-3 tracking-wide">Apps</h4>
              <div className="space-y-2">
                <a 
            ...
            {/* Community */}
            <div>
              <h4 className="text-xl font-medium text-black mb-3 tracking-wide">Community</h4>
              <div className="space-y-2">
                <a 
