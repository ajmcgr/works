...
const Header = () => {
  ...
  return (
    <header className={`w-full z-50 fixed top-0 flex justify-center transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
      <div className="mt-4 bg-white/40 backdrop-blur-sm rounded-md px-6">
        {/* Desktop Layout */}
        <div className="hidden md:flex items-center justify-center gap-8 h-14">
          ...
          <div className="flex items-center space-x-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent 
                className="bg-white border border-gray-200 shadow-lg rounded-md p-2 w-80 z-[60]"
              >
                <DropdownMenuItem 
        ...
        <div className="md:hidden min-w-[280px]">
          ...
          {/* Mobile Menu Overlay */}
          {isMobileMenuOpen && (
            <div className="absolute top-14 left-0 right-0 bg-white/40 backdrop-blur-sm shadow-lg rounded-md z-50">
              <div className="px-6 py-4 space-y-4">
                ...
                <div className="relative">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent 
                      className="bg-white border border-gray-200 shadow-lg rounded-md p-1 w-80 z-[60]"
                    >
                      <DropdownMenuItem 
                        onClick={() => {
