        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Interpretation</h2>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Works App, Inc. 651 N Broad St, Suite 201, Middletown, 19709, Delaware.</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">By accessing or using the Service:</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                <li>You agree to be bound by these Terms and Conditions.</li>
                <li>If You disagree with any part of these Terms and Conditions then You may not access the Service.</li>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Subscription period</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Subscription cancellations</h3>
              <p className="text-gray-700 mb-4">
