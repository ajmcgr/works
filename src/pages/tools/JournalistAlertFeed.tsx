        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground italic mb-4">
              "The journalist alert feed helped us secure coverage in Forbes within a week of launch. The timing was perfect!"
            </p>
            <p className="text-sm font-medium text-foreground">Lisa Zhang, PR Manager at StartupFlow</p>
          </div>
        </div>
      </section>
    </div>
