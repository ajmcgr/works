          ...
          {/* Touch-native CTA */}
            <div>
               <a href="https://cal.com/works" target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center px-8 py-6 rounded-lg bg-white/10 backdrop-blur-md border-2 border-white/20 text-white text-lg font-semibold transition-all duration-300 hover:bg-white/20 hover:border-white/30">
