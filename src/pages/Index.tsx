      ...
      >
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto w-full px-4 md:px-6">
          ...
          <div className="mb-6 md:mb-8">
            <h1 className="font-headline text-white mb-4 md:mb-6 text-5xl md:text-6xl lg:text-7xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)]" style={{ letterSpacing: '0px', fontSize: 'clamp(3rem, 5vw, 4.5rem)' }}>
              We Connect Creators & Brands
            </h1>
            
            <p className="text-white font-medium text-lg md:text-xl mb-4 md:mb-6 max-w-3xl mx-auto leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
