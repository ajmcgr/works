    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-[150vh] flex flex-col justify-center items-center relative overflow-hidden pt-0 pb-0 px-4 md:px-6">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto w-full -mt-8">
          ...
          <div className="mb-6 md:mb-8">
            <h1 className="font-headline text-foreground mb-4 md:mb-6 kinetic-slide in-view text-5xl md:text-6xl lg:text-7xl" style={{ animationDelay: '0.3s', letterSpacing: '0.15px' }}>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 reveal-on-scroll">
            <h2 className="font-headline text-foreground mb-6 text-3xl md:text-4xl lg:text-5xl" style={{ letterSpacing: '0.15px' }}>
              How we can help
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div key={index} className="bg-white rounded-3xl p-8 shadow-lg reveal-on-scroll touch-hover" style={{ animationDelay: `${index * 0.1}s` }}>
                <h3 className="text-xl font-bold text-foreground mb-4" style={{ letterSpacing: '0.15px' }}>{service.title}</h3>
      ...
      <section className="min-h-screen py-20 px-6 bg-foreground text-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 reveal-on-scroll">
            <h2 className="font-headline text-background mb-6 text-3xl md:text-4xl lg:text-5xl" style={{ letterSpacing: '0.15px' }}>
              Our Process
            </h2>
            ...
            {[
              ...
              <div key={index} className="reveal-on-scroll" style={{ animationDelay: `${index * 0.2}s` }}>
                <div className="bg-background/5 backdrop-blur-sm rounded-3xl p-8 touch-hover h-full">
                  ...
                  <h3 className="text-2xl font-bold text-background mb-2" style={{ letterSpacing: '0.15px' }}>{tool.name}</h3>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-white rounded-3xl p-8 shadow-xl reveal-on-scroll touch-hover">
              <div className="flex items-center mb-6">
                <div>
                  <h4 className="font-bold text-foreground text-2xl" style={{ letterSpacing: '0.15px' }}>UFC</h4>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl reveal-on-scroll touch-hover" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center mb-6">
                <div>
                  <h4 className="font-bold text-foreground text-2xl" style={{ letterSpacing: '0.15px' }}>OnePlus</h4>
          ...
          <div className="space-y-12">
            <div className="bg-white rounded-3xl p-12 shadow-xl reveal-on-scroll touch-hover">
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h4 className="font-bold text-foreground text-lg" style={{ letterSpacing: '0.15px' }}>Dana White</h4>
            ...
            <div className="bg-white rounded-3xl p-12 shadow-xl reveal-on-scroll touch-hover" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h4 className="font-bold text-foreground text-lg" style={{ letterSpacing: '0.15px' }}>Pete Lau</h4>
            ...
            <div className="bg-white rounded-3xl p-12 shadow-xl reveal-on-scroll touch-hover" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h4 className="font-bold text-foreground text-lg" style={{ letterSpacing: '0.15px' }}>Tina Sharkey</h4>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-16 reveal-on-scroll">
            <h2 className="font-headline text-black mb-6 text-3xl md:text-4xl lg:text-5xl" style={{ letterSpacing: '0.15px' }}>
