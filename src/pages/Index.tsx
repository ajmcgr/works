      ...
      <section className="min-h-[150vh] flex flex-col justify-center items-center relative overflow-hidden pt-0 pb-0 px-4 md:px-6">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto w-full -mt-16">
          ...
          <div className="mb-6 md:mb-8">
            <h1 className="font-headline text-foreground mb-4 md:mb-6 kinetic-slide in-view text-5xl md:text-5xl lg:text-6xl" style={{ animationDelay: '0.3s', letterSpacing: '0px' }}>
