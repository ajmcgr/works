...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="min-h-[150vh] flex flex-col justify-center items-center relative overflow-hidden pt-16 md:pt-16 pb-0 px-4 md:px-6" style={{ backgroundImage: 'url(/lovable-uploads/7274cc69-8d35-40ef-ad17-033424367b56.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        {/* Kinetic background */}
