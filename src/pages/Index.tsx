...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="min-h-[150vh] flex flex-col justify-center items-center relative overflow-hidden pt-8 pb-16 px-4 md:px-6">
        {/* Kinetic background */}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto w-full">
          ...
          <div className="mt-8 md:mt-12 kinetic-slide in-view w-full" style={{ animationDelay: '1.2s' }}>
            <div className="w-full h-80 md:h-96 lg:h-[500px] overflow-hidden relative bg-black rounded-[7.5px]">
              <iframe
