...
const CaseStudyDetail = () => {
  ...
  const caseStudies = {
    ...
    "byd": {
      ...
      challenge: "Upgrade BYD's brand overseas across all product lines while converting global sponsorships, including Manchester City, into genuine brand equity.",
      solution: "Built a unified global brand platform linking product storytelling, auto-show moments, and sponsorship activation across Europe, APAC and LATAM.",
      results: [
        "Consistent premium brand narrative across every overseas product line",
      ...
      detailedChallenge: "BYD entered key overseas markets needing to reframe the narrative around Chinese EV makers — moving the conversation from price competition to design, technology leadership, and sustainability. The brand also had to speak coherently across very different product lines: passenger EVs, commercial vehicles and buses, and energy storage. At the same time, a growing sponsorship portfolio — headlined by the Manchester City partnership — risked becoming pure logo placement unless it was tied back to a single global brand story.",
      detailedSolution: "We built an integrated brand communications program designed to position BYD as a category-defining mobility and energy brand overseas:\n\n• Crafted a unified brand narrative spanning passenger EVs, commercial vehicles, and energy storage\n• Orchestrated press moments around flagship vehicles at major European and APAC auto shows\n• Turned the Manchester City partnership into a content and earned-media engine — matchday activations, fan experiences, player-led content, and stadium fleet stories\n• Positioned senior executives as thought leaders on EV strategy, batteries, and the energy transition\n• Built relationships with tier-1 automotive, business, sport and lifestyle media across EMEA, APAC and LATAM\n• Designed experiential press drives and showroom activations to translate specs into emotion\n• Coordinated regional spokespeople and localized messaging without diluting the global brand voice",
      detailedResults: "The program reset BYD's overseas positioning across the portfolio:\n\n• Secured sustained tier-1 coverage in outlets including Reuters, Bloomberg, Top Gear, and Auto Express\n• Extended the Manchester City partnership beyond visibility into sustained earned coverage in sport and business media\n• Drove a measurable lift in unaided brand awareness and premium perception in target overseas markets\n• Owned share-of-voice during key auto show windows versus established European OEMs\n• Aligned messaging across passenger, commercial and energy storage lines under one brand story",
      media: [
